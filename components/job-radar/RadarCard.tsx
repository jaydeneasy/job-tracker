        ...
        <div className="flex items-start justify-between gap-2">
          ...
          <div className="flex items-center gap-1 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
            <button
              ...
              className="flex items-center gap-1 rounded px-2 py-1 text-[11px] font-medium text-[#818cf8] bg-[#6366f1]/15 hover:bg-[#6366f1]/25 transition-colors"
            ...
            <button
              ...
              className="rounded p-1 text-[#55556a] hover:text-[#8888a8] hover:bg-[#16161e] transition-colors"
              title="Dismiss"
            >
              <X size={12} />
            </button>
